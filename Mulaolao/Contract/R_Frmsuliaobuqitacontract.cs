...
namespace Mulaolao . Contract
{
    public partial class R_Frmsuliaobuqitacontract :FormChild
    {
        ...
        void every ( )
        {
            model . PJ95 = comboBox5 . Text;
            if ( !string . IsNullOrEmpty ( textBox17 . Text ) )
            {
                model . PJ01 = textBox17 . Text;

                wpmc = SqlHelper . ExecuteDataTable ( "SELECT DISTINCT GS07 PJ09,GS08 PJ89,GS09 PJ17,GS10 PJ11,GS71 PJ105,GS02 PJ111 FROM R_PQP WHERE GS07!='' AND GS70='R_347' AND GS01 =@GS01" ,new SqlParameter ( "@GS01" ,model . PJ01 ) );
                ...
                biao = SqlHelper . ExecuteDataTable ( "SELECT '' PJ09,PJ10,0.0 PJ11,'' PJ105,'' PJ111,PJ12,PJ13,PJ14,PJ15,PJ16,'' PJ17,PJ18,'' PJ89 FROM R_PQS WHERE PJ01=@PJ01" ,new SqlParameter ( "@PJ01" ,model . PJ01 ) );
            }

            if ( string . IsNullOrEmpty ( textBox17 . Text ) )
                biao = SqlHelper . ExecuteDataTable ( "SELECT PJ09,PJ10,PJ11,PJ105,PJ111,PJ12,PJ13,PJ14,PJ15,PJ16,PJ17,PJ18,PJ89 FROM R_PQS WHERE PJ95=@PJ95" ,new SqlParameter ( "@PJ95" ,model . PJ95 ) );
            //else
            //{
            //    PJ01 = textBox17.Text;
            //    if ( !string . IsNullOrEmpty ( PJ01 ) )
            ...
            if ( biao != null && biao . Rows . Count > 0 )
            {
                ...
                partTable = biao . DefaultView . ToTable ( true ,"PJ09" ,"PJ89" ,"PJ11" ,"PJ105" ,"PJ111" );
        ...
        private void gridLookUpEdit1_EditValueChanged ( object sender ,EventArgs e )
        {
            ...
            txtPJ111 . Text = row [ "PJ111" ] . ToString ( );
            previousOfPrice ( );
        }
        //物料名称
        ...
        private void gridView1_RowClick ( object sender ,DevExpress . XtraGrid . Views . Grid . RowClickEventArgs e )
        {
            ...
            if ( !string . IsNullOrEmpty ( row [ "idx" ] . ToString ( ) ) )
                model . IDX = Convert . ToInt64 ( row [ "idx" ] . ToString ( ) );
            txtPJ111 . Text = row [ "PJ111" ] . ToString ( );
        ...
        private void lookUpEdit1_EditValueChanged ( object sender ,EventArgs e )
        {
            ...
            {
                model . PJ02 = lookUpEdit1 . EditValue . ToString ( );
                textBox3 . Text = name . Select ( "DBA001='" + model . PJ02 + "'" ) [ 0 ] [ "DBA028" ] . ToString ( );
            }
        }
        //乙方
        private void textBox1_TextChanged ( object sender ,EventArgs e )
        {
            DataTable drt = SqlHelper . ExecuteDataTable ( "SELECT DGA003,DGA011,DGA017,DGA009 FROM TPADGA WHERE DGA001=@DGA001" ,new SqlParameter ( "@DGA001" ,model . PJ03 ) );
            if ( drt . Rows . Count > 0 )
            {
        ...
        private void button11_Click ( object sender ,EventArgs e )
        {
            if ( string . IsNullOrEmpty ( textBox9 . Text ) )
            {
                ...
                model . PJ04 = textBox9 . Text;
                string [ ] str = new string [ 2 ];
                str = oddNumbers . contractBatch ( "R_PQS" ,model . PJ04 ,textBox9 ,textBox14 ,"PJ08" );
                if ( str [ 0 ] == "" )
                    textBox9 . Text = "";
                else
                    model . PJ08 = str [ 1 ];
        ...
        void queryContent ( )
        {
            ...
            if ( dei . Rows . Count > 0 )
            {
                ...
                #region
                textBox1 . Text = model . PJ03 = dei . Rows [ 0 ] [ "PJ03" ] . ToString ( );
                ...
                #endregion
                //,PJ100
                de = SqlHelper . ExecuteDataTable ( "SELECT idx,PJ09,PJ10,PJ89,PJ11,PJ12,PJ13,PJ14,PJ15,PJ16,PJ17,PJ18,PJ19,PJ20,PJ96,PJ97,PJ102,PJ103,PJ105,PJ111 FROM R_PQS WHERE PJ92=@PJ92 AND PJ09!='' AND PJ09 IS NOT NULL ORDER BY idx DESC" ,new SqlParameter ( "@PJ92" ,model . PJ92 ) );
        ...
        private void query_PassDataBetweenForm ( Object sender ,PassDataWinFormEventArgs e )
        {
            ...
            if ( e . ConEleven == "" )
                ...
                model . PJ96 = Convert . ToInt64 ( e . ConEleven );
        ...
        void pq_PassDataBetweenForm ( object sender ,PassDataWinFormEventArgs e )
        {
            ...
            if ( !string . IsNullOrEmpty ( e . ConTre ) )
                model . PJ96 = Convert . ToInt64 ( e . ConTre );
            else
                model . PJ96 = 0;
        ...
        private void button6_Click ( object sender ,EventArgs e )
        {
            ...
            {
                DataTable dee = SqlHelper . ExecuteDataTable ( "SELECT DISTINCT GS07,GS08,GS10,GS09 FROM R_PQP A,R_REVIEWS B,R_MLLCXMC C WHERE A.GS34=B.RES06 AND B.RES01=C.CX01 AND RES05='执行' AND CX02='产品每套成本改善控制表(R_509)' AND GS07 IS NOT NULL AND GS07!='' AND GS01=@GS01" ,new SqlParameter ( "@GS01" ,model . PJ01 ) );
                if ( dee . Rows . Count < 1 )
        ...
        protected override void revirw ( )
        {
            ...
            if ( string . IsNullOrEmpty ( textBox11 . Text ) )
                ...
                over = true;
            Reviews ( "PJ92" ,model . PJ92 ,"R_PQS" ,this ,model . PJ01 ,"R_347" ,result ,over ,null/*,"PJ06" ,"PJ85" ,"R_PQS" ,"PJ92" ,PJ92 ,ord ,textBox17.Text,"R_347"*/ );
            result = false;
        ...
        void trueOrFalse ( )
        {
            ...
            if ( ( string . IsNullOrEmpty ( textBox17 . Text ) && gridView1 . GetDataRow ( 0 ) [ "PJ15" ] . ToString ( ) == "外购" ) || ( !string . IsNullOrEmpty ( textBox17 . Text ) && gridView1 . GetDataRow ( 0 ) [ "PJ15" ] . ToString ( ) == "库存" ) )
            {
                ...
                {
                    if ( sp . inOut ( model . PJ92 ,gridView1 . GetDataRow ( i ) [ "PJ09" ] . ToString ( ) ,model . PJ95 ,gridView1 . GetDataRow ( i ) [ "PJ89" ] . ToString ( ) ) == false )
                    {
                        //所有都不等就是没有出或入
                        result = false;
                        break;
        ...
        void updates ( )
        {
            ...
            strSql . AppendFormat ( "UPDATE R_PQS SET PJ01='{0}',PJ02='{1}',PJ03='{2}',PJ04='{3}',PJ06='{4}',PJ08='{5}',PJ21='{6}',PJ22='{7}',PJ24='{8}',PJ25='{9}',PJ27='{10}',PJ28='{11}',PJ30='{12}',PJ31='{13}',PJ33='{14}',PJ34='{15}',PJ35='{16}',PJ36='{17}',PJ37='{18}',PJ38='{19}',PJ39='{20}',PJ40='{21}',PJ41='{22}',PJ42='{23}',PJ43='{24}',PJ44='{25}',PJ45='{26}',PJ46='{27}',PJ47='{28}',PJ48='{29}',PJ49='{30}',PJ50='{31}',PJ51='{32}',PJ52='{33}',PJ53='{34}',PJ54='{35}',PJ55='{36}',PJ56='{37}',PJ57='{38}',PJ58='{39}',PJ59='{40}',PJ60='{41}',PJ61='{42}',PJ62='{43}',PJ63='{44}',PJ65='{45}',PJ66='{46}',PJ67='{47}',PJ68='{48}',PJ78='{49}',PJ80='{50}',PJ81='{51}',PJ83='{52}',PJ85='{53}',PJ64='{54}',PJ69='{55}',PJ70='{56}',PJ71='{57}',PJ72='{58}',PJ73='{59}',PJ74='{60}',PJ75='{61}',PJ76='{62}',PJ77='{63}',PJ05='{64}',PJ07='{65}',PJ23='{66}',PJ26='{67}',PJ29='{68}',PJ32='{69}',PJ79='{70}',PJ82='{71}',PJ84='{72}',PJ86='{73}',PJ87='{74}',PJ88='{75}',PJ90='{76}',PJ91='{77}',PJ93='{78}',PJ94='{79}',PJ95='{80}',PJ100='{81}',PJ101='{82}',PJ99='',PJ106='{84}' WHERE PJ92='{83}'" ,model . PJ01 ,model . PJ02 ,model . PJ03 ,model . PJ04 ,model . PJ06 ,model . PJ08 ,model . PJ21 ,model . PJ22 ,model . PJ24 ,model . PJ25 ,model . PJ27 ,model . PJ28 ,model . PJ30 ,model . PJ31 ,model . PJ33 ,model . PJ34 ,model . PJ35 ,model . PJ36 ,model . PJ37 ,model . PJ38 ,model . PJ39 ,model . PJ40 ,model . PJ41 ,model . PJ42 ,model . PJ43 ,model . PJ44 ,model . PJ45 ,model . PJ46 ,model . PJ47 ,model . PJ48 ,model . PJ49 ,model . PJ50 ,model . PJ51 ,model . PJ52 ,model . PJ53 ,model . PJ54 ,model . PJ55 ,model . PJ56 ,model . PJ57 ,model . PJ58 ,model . PJ59 ,model . PJ60 ,model . PJ61 ,model . PJ62 ,model . PJ63 ,model . PJ65 ,model . PJ66 ,model . PJ67 ,model . PJ68 ,model . PJ78 ,model . PJ80 ,model . PJ81 ,model . PJ83 ,model . PJ85 ,model . PJ64 ,model . PJ69 ,model . PJ70 ,model . PJ71 ,model . PJ72 ,model . PJ73 ,model . PJ74 ,model . PJ75 ,model . PJ76 ,model . PJ77 ,model . PJ05 ,model . PJ07 ,model . PJ23 ,model . PJ26 ,model . PJ29 ,model . PJ32 ,model . PJ79 ,model . PJ82 ,model . PJ84 ,model . PJ86 ,model . PJ87 ,model . PJ88 ,model . PJ90 ,model . PJ91 ,model . PJ93 ,model . PJ94 ,model . PJ95 ,model . PJ100 ,model . PJ101 ,model . PJ92 ,model . PJ106 );
        ...
        void getValue ( )
        {
            model . PJ100 = checkBox17 . Checked == true ? "T" : "F";
            if ( !string . IsNullOrEmpty ( textBox13 . Text ) )
                model . PJ94 = textBox13 . Text;
            else
                model . PJ94 = "";
            if ( !string . IsNullOrEmpty ( textBox21 . Text ) )
                model . PJ96 = Convert . ToInt64 ( textBox21 . Text );
            else
                model . PJ96 = 0;
            model . PJ93 = comboBox4 . Text;
            model . PJ101 = lookUpEdit2 . Text;
            model . PJ04 = textBox9 . Text;
            model . PJ05 = dateTimePicker1 . Value;
            model . PJ06 = textBox11 . Text;
            model . PJ07 = dateTimePicker2 . Value;
            model . PJ08 = textBox14 . Text;
            model . PJ21 = textBox31 . Text;
            model . PJ22 = comboBox19 . Text;
            model . PJ23 = dateTimePicker6 . Value;
            model . PJ24 = textBox36 . Text;
            model . PJ25 = comboBox18 . Text;
            model . PJ26 = dateTimePicker7 . Value;
            model . PJ27 = textBox39 . Text;
            model . PJ28 = comboBox16 . Text;
            model . PJ29 = dateTimePicker8 . Value;
            model . PJ30 = textBox42 . Text;
            model . PJ31 = comboBox14 . Text;
            model . PJ32 = dateTimePicker9 . Value;
            model . PJ33 = textBox30 . Text;
            model . PJ34 = textBox33 . Text;
            model . PJ35 = checkBox21 . Checked == true ? "T" : "F";
            model . PJ36 = checkBox22 . Checked == true ? "T" : "F";
            model . PJ37 = checkBox23 . Checked == true ? "T" : "F";
            model . PJ38 = checkBox24 . Checked == true ? "T" : "F";
            model . PJ39 = checkBox5 . Checked == true ? "T" : "F";
            model . PJ40 = checkBox6 . Checked == true ? "T" : "F";
            model . PJ41 = checkBox7 . Checked == true ? "T" : "F";
            model . PJ42 = checkBox1 . Checked == true ? "T" : "F";
            model . PJ43 = checkBox2 . Checked == true ? "T" : "F";
            model . PJ44 = checkBox4 . Checked == true ? "T" : "F";
            model . PJ45 = checkBox3 . Checked == true ? "T" : "F";
            model . PJ46 = checkBox8 . Checked == true ? "T" : "F";
            model . PJ47 = checkBox9 . Checked == true ? "T" : "F";
            model . PJ48 = checkBox11 . Checked == true ? "T" : "F";
            model . PJ49 = checkBox10 . Checked == true ? "T" : "F";
            model . PJ50 = checkBox12 . Checked == true ? "T" : "F";
            ...
            {
                model . PJ53 = "已检测";
                model . PJ54 = textBox43 . Text;
            }
            else if ( radioButton5 . Checked )
            {
                model . PJ53 = "未检测";
            }
            model . PJ55 = textBox45 . Text;
            model . PJ56 = textBox44 . Text;
            model . PJ57 = checkBox13 . Checked == true ? "T" : "F";
            model . PJ58 = checkBox14 . Checked == true ? "T" : "F";
            model . PJ59 = checkBox15 . Checked == true ? "T" : "F";
            model . PJ60 = checkBox16 . Checked == true ? "T" : "F";
            model . PJ61 = checkBox18 . Checked == true ? "T" : "F";
            model . PJ62 = checkBox19 . Checked == true ? "T" : "F";
            model . PJ63 = checkBox20 . Checked == true ? "T" : "F";
            model . PJ64 = string . IsNullOrEmpty ( textBox55 . Text ) == true ? 0 : Convert . ToInt64 ( textBox55 . Text );
            ...
            {
                model . PJ65 = "条件接收";
                model . PJ66 = textBox25 . Text;
            }
            else if ( radioButton9 . Checked )
            {
                model . PJ65 = "退货";
            }
            model . PJ67 = comboBox12 . Text;
            model . PJ68 = comboBox11 . Text;
            model . PJ78 = comboBox10 . Text;
            model . PJ79 = dateTimePicker10 . Value;
            model . PJ69 = string . IsNullOrEmpty ( textBox57 . Text ) == true ? 0 : Convert . ToInt64 ( textBox57 . Text );
            model . PJ70 = string . IsNullOrEmpty ( textBox58 . Text ) == true ? 0 : Convert . ToInt64 ( textBox58 . Text );
            model . PJ71 = string . IsNullOrEmpty ( textBox59 . Text ) == true ? 0 : Convert . ToInt64 ( textBox59 . Text );
            model . PJ72 = string . IsNullOrEmpty ( textBox18 . Text ) == true ? 0 : Convert . ToInt64 ( textBox18 . Text );
            model . PJ73 = string . IsNullOrEmpty ( textBox12 . Text ) == true ? 0 : Convert . ToInt64 ( textBox12 . Text );
            model . PJ74 = string . IsNullOrEmpty ( textBox10 . Text ) == true ? 0 : Convert . ToInt64 ( textBox10 . Text );
            model . PJ75 = string . IsNullOrEmpty ( textBox24 . Text ) == true ? 0 : Convert . ToInt64 ( textBox24 . Text );
            model . PJ76 = string . IsNullOrEmpty ( textBox23 . Text ) == true ? 0 : Convert . ToInt64 ( textBox23 . Text );
            model . PJ77 = string . IsNullOrEmpty ( textBox22 . Text ) == true ? 0 : Convert . ToInt64 ( textBox22 . Text );
            model . PJ80 = textBox68 . Text;
            model . PJ81 = textBox69 . Text;
            model . PJ82 = dateTimePicker11 . Value;
            model . PJ83 = textBox71 . Text;
            model . PJ84 = dateTimePicker12 . Value;
            model . PJ85 = textBox27 . Text;
            model . PJ86 = dateTimePicker15 . Value;
            model . PJ87 = dateTimePicker13 . Value;
            model . PJ88 = dateTimePicker3 . Value;
            model . PJ106 = checkBox25 . Checked == true ? "T" : "F";
            model . PJ90 = textBox29 . Text;
            model . PJ91 = "";
            model . PJ01 = textBox17 . Text;
        ...
        protected override void save ( )
        {
            ...
            if ( weihu . Equals ( "1" ) )
            {
                ...
                else
                {
                    ...
                    {
                        model . PJ91 = drt . Rows [ 0 ] [ "PJ91" ] . ToString ( ) + "[" + Logins . username + MulaolaoBll . Drity . GetDt ( ) . ToString ( "yyyyMMdd" ) + "]";
                        stateOfOdd = "维护保存";
                        StringBuilder strSql = new StringBuilder ( );
            ...
            else
            {
                ...
                else
                {
                    if ( copy == "1" )
                    {
                        if ( MulaolaoBll . WriteReceivableToGeneralLedger . ExistsSup ( model . PJ03 ) == false )
                        {
                        ...
                        else
                        {
                            ...
                            for ( int i = 0 ; i < gridView1 . RowCount ; i++ )
                            {
                                ...
                                if ( ord == "计划" || string . IsNullOrEmpty ( textBox17 . Text ) )
                                {
                                    if ( dru . Select ( "PJ09='" + gridView1 . GetDataRow ( i ) [ "PJ09" ] . ToString ( ) + "' AND PJ89='" + gridView1 . GetDataRow ( i ) [ "PJ89" ] . ToString ( ) + "' AND PJ95='" + model . PJ95 + "'" ) . Length > 0 )
                                    {
                                        if ( model . PJ08 . Length > 8 && model . PJ08 . Substring ( 0 ,8 ) == "MLL-0001" )
                                        {
                                            updates ( );
                                            break;
                                        }
                                ...
                                else if ( ord == "实际" || !string . IsNullOrEmpty ( textBox17 . Text ) )
                                {
                                    ...
                                    if ( dru . Select ( "PJ09='" + gridView1 . GetDataRow ( i ) [ "PJ09" ] . ToString ( ) + "' AND PJ89='" + gridView1 . GetDataRow ( i ) [ "PJ89" ] . ToString ( ) + "' AND PJ01='" + model . PJ01 + "'" ) . Length > 0 )
                                    {
                                        if ( model . PJ08 . Length > 8 && model . PJ08 . Substring ( 0 ,8 ) == "MLL-0001" )
                                        {
                                            updates ( );
        ...
        void getSet ( )
        {
            ...
            if ( !string . IsNullOrEmpty ( comboBox13 . Text ) )
                model . PJ10 = Convert . ToInt64 ( comboBox13 . Text );
            else
                model . PJ10 = 0;
            if ( !string . IsNullOrEmpty ( textBox37 . Text ) )
                model . PJ11 = Convert . ToDecimal ( textBox37 . Text );
            else
                model . PJ11 = 0;
            if ( !string . IsNullOrEmpty ( comboBox3 . Text ) )
                model . PJ12 = Convert . ToDecimal ( comboBox3 . Text );
            else
                model . PJ12 = 0;
            if ( !string . IsNullOrEmpty ( textBox7 . Text ) )
                model . PJ13 = Convert . ToDecimal ( textBox7 . Text );
            else
                model . PJ13 = 0;
            if ( radioButton10 . Checked )
            {
                ...
                if ( string . IsNullOrEmpty ( textBox15 . Text ) )
                    ...
                    model . PJ14 = Convert . ToDecimal ( textBox15 . Text );
                model . PJ97 = 0;
            }
            else if ( radioButton11 . Checked )
            {
                ...
                if ( string . IsNullOrEmpty ( textBox35 . Text ) )
                    ...
                    model . PJ97 = Convert . ToDecimal ( textBox35 . Text );
                model . PJ14 = 0;
            }
            if ( !string . IsNullOrEmpty ( comboBox15 . Text ) )
                model . PJ16 = Convert . ToDecimal ( comboBox15 . Text );
            else
                model . PJ16 = 0;
            model . PJ17 = comboBox8 . Text;
            model . PJ18 = comboBox17 . Text;
            model . PJ19 = dateTimePicker4 . Value;
            model . PJ20 = dateTimePicker5 . Value;
            model . PJ89 = textBox26 . Text;
            model . PJ09 = gridLookUpEdit1 . Text;
            model . PJ105 = textBox38 . Text;
            model . PJ111 = txtPJ111 . Text;
        }
        void build ( )
        {
            ...
            if ( result == false )
            {
                ...
                MessageBox . Show ( "单号：" + model . PJ92 + "\n\r物品名称：" + model . PJ09 + "\n\r公差尺寸含长宽高：" + model . PJ89 + "\n\r的数据已经存在,请核实后再录入" );
        }
        void buildes ( )
        {
            DataTable dn = bll . getTableForBuild ( model );
            if ( dn . Rows . Count > 0 )
            {
                if ( dn . Select ( "PJ11='" + model . PJ11 + "'" ) . Length <= 0 )
                    MessageBox . Show ( "每套用量与计划订单不一致,应为:" + dn . Rows [ 0 ] [ "PJ11" ] . ToString ( ) + "" );
                else
                {
                    if ( dn . Select ( "PJ12='" + model . PJ12 + "'" ) . Length <= 0 )
        ...
        private void button1_Click ( object sender ,EventArgs e )
        {
            ...
            if ( string . IsNullOrEmpty ( model . PJ03 ) || string . IsNullOrEmpty ( textBox1 . Text ) )
            {
            ...
            if ( ord == "计划" || string . IsNullOrEmpty ( textBox17 . Text ) )
            {
                ...
                DataTable yesNoAcPlan = SqlHelper . ExecuteDataTable ( "SELECT AC03,AC18 FROM R_PQAC WHERE AC18=(SELECT MAX(AC18) FROM R_PQAC WHERE AC02=@AC02 AND AC04=@AC04 AND AC05=@AC05)" ,new SqlParameter ( "@AC02" ,model . PJ95 ) ,new SqlParameter ( "@AC04" ,model . PJ09 ) ,new SqlParameter ( "@AC05" ,model . PJ89 ) );
            ...
            else if ( ord == "实际" || !string . IsNullOrEmpty ( textBox17 . Text ) )
            {
                ...
                bool result = pc . PlanActual ( model . PJ09 ,model . PJ89 ,model . PJ95 );
                bool vode = pc . PlanInDataBaseSu ( model . PJ01 ,model . PJ09 ,model . PJ89 );
                if ( result == true )
                {
                    if ( vode == true )
                        outSouce ( );
        ...
        private void button2_Click ( object sender ,EventArgs e )
        {
            ...
            if ( model . PJ09 == pj9 && model . PJ89 == gs008 )
            {
                if ( radioButton10 . Checked )
                {
                    if ( !string . IsNullOrEmpty ( textBox34 . Text ) && !string . IsNullOrEmpty ( textBox15 . Text ) )
            ...
            else
            {
                ...
                {
                    //AND PJ04=@PJ04
                    DataTable dwo = SqlHelper . ExecuteDataTable ( "SELECT * FROM R_PQS WHERE PJ01=@PJ01 AND PJ09=@PJ09 AND PJ89=@PJ89  AND PJ15=@PJ15" ,new SqlParameter ( "@PJ01" ,model . PJ01 ) ,new SqlParameter ( "@PJ09" ,model . PJ09 ) ,new SqlParameter ( "@PJ89" ,model . PJ89 ) /*,new SqlParameter( "@PJ04" ,PJ04 )*/ ,new SqlParameter ( "@PJ15" ,model . PJ15 ) );
                    if ( dwo . Rows . Count > 0 )
                    {
                        //开过的合同中是否包含此流水(针对可能合批)
                        for ( int k = 0 ; k < dwo . Rows . Count ; k++ )
                        {
                            if ( dwo . Rows [ k ] [ "PJ01" ] . ToString ( ) . Contains ( model . PJ01 ) || model . PJ01 . Contains ( dwo . Rows [ k ] [ "PJ01" ] . ToString ( ) ) )
                            {
                                if ( model . PJ08 . Length > 0 && model . PJ08 . Substring ( 0 ,8 ) == "MLL-0001" )
                                {
                                    planOrActual ( );
                                    break;
                                }
