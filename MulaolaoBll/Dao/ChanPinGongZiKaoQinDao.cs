...
namespace MulaolaoBll.Dao
{
    public class ChanPinGongZiKaoQinDao
    {
        ...
        {
            StringBuilder strSql = new StringBuilder ( );
            strSql . Append ( "SELECT DBA001,DBA002 FROM TPADBA A INNER JOIN TPADAA B ON A.DBA005=B.DAA001 WHERE DAA001 LIKE '08%' AND DAA001!='08' AND (DBA043='F' OR DBA043='' OR DBA043 IS NULL)" );
        ...
        {
            StringBuilder strSql = new StringBuilder ( );
            strSql . Append ( "SELECT DBA001,DBA002 FROM TPADBA WHERE DBA005 IN (SELECT DAA001 FROM TPADAA WHERE DAA002 IN (SELECT DBA002 FROM TPADBA WHERE DBA005=(SELECT DAA001 FROM TPADAA WHERE DAA002='生产部')) AND (DBA043='F' OR DBA043='' OR DBA043 IS NULL))  or DBA005 in (SELECT DAA001 FROM TPADAA WHERE DAA002='生产部')" );
